param(
    [string]$BaselinePath = "$PSScriptRoot/../baselines/sharepoint/sharepoint.yml",
    [string]$RuleRoot     = "$PSScriptRoot/../modules/scanner/rules/sharepoint",
    [switch]$ConnectTenant,
    [string]$ExchangeUserPrincipalName,
    [System.Management.Automation.PSCredential]$Credential,
    [switch]$ConnectGraph,
    [string[]]$GraphScopes = @('Sites.Read.All','Policy.Read.All','Directory.Read.All'),
