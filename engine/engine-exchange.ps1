param(
    [string]$BaselinePath = "$PSScriptRoot/../baselines/exchange/exchange.yml",
    [string]$RuleRoot     = "$PSScriptRoot/../modules/scanner/rules/exchange",
    [switch]$ConnectTenant,
    [string]$ExchangeUserPrincipalName,
    [System.Management.Automation.PSCredential]$Credential,
    [switch]$ConnectGraph,
    [string[]]$GraphScopes = @('User.Read.All','Policy.Read.All','Mail.ReadBasic.All'),
