param(
    [string]$BaselinePath = "$PSScriptRoot/../baselines/teams/teams.yml",
    [string]$RuleRoot     = "$PSScriptRoot/../modules/scanner/rules/teams",
    [switch]$ConnectTenant,
    [string]$ExchangeUserPrincipalName,
    [System.Management.Automation.PSCredential]$Credential,
    [switch]$ConnectGraph,
    [string[]]$GraphScopes = @('Policy.Read.All','Directory.Read.All','User.Read.All'),
